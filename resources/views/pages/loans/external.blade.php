        ...
        <div class="card-header">
            <div class="card-body">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="specialimprest-tab" data-toggle="tab" href="#loans taken"
                            role="tab" aria-controls="specialimprest" aria-selected="true">Loans Taken</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="viewimprestbalance-tab" data-toggle="tab" href="#deposit the loan"
                            role="tab" aria-controls="viewimprestbalance" aria-selected="false">Deposit the loan</a>
                    </li>
                </ul>
