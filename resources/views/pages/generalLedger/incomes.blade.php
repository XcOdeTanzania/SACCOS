        ...
        <div class="col-xl-12">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <div class="col">
                        <div class="row">
                            <label for="user" class="col-form-label mr-2">Ledger Name:</label>
                        <div>
                            <select id="user" class="custom-select custom-select-sm" name="user">
                            <option selected="">Open this select menu</option>
                            <option value="1">Monthly charges</option>
                            <option value="2">Entrance fees</option>
                        ...
                        <div class="row from-control">
                            ...
                            <div class="col mt-2"><div class="row">Loan Interest Ledger, Year:2016
                            </div></div> 
                            </div>
                            </div>
                            <div class="card-body">
