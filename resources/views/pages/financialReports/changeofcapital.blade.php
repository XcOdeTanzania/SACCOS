    ...
    <div class="col-xl-12">
        ...
        <div class="card card-default">
            <div class="card-header">
                <div class="col">
                    <div class="row">
                        <label for="user" class="col-form-label mr-4">1st Year From:</label>
                        <div>
                        ...
                        <label for="user" class="col-form-label mr-2">To:</label>
                        <div>
                            <div class="input-group date AngleDate">
                                <input id="from" class="form-control" type="text" />
                                <span class="input-group-append input-group-addon">
                    ...
                    <div class="row">
                        <label for="user" class="col-form-label mr-4">2nd Year From:</label>
                        <div>
                            <div class="input-group date AngleDate">
                                <input id="from" class="form-control" type="text" />
                                <span class="input-group-append input-group-addon">
