    ...
    <div class="card-body">
        <form class="form-horizontal" method="get" action="/">
            ...
            <fieldset>
                ...
                <div class="form-group row mb-2"><label class="col-md-2 col-form-label mb-2">Cheque</label>
                    <div class="col-xl-6 col-10">
                        <div class="input-group date" id="datetimepicker1"><input class="form-control" type="text"><span
                                class="input-group-append input-group-addon"></span></div>
                    </div>
                ...
                <div class="form-group row"><label class="col-md-2 col-form-label" for="input-id-1">Initial
                        Repayment</label>
                    <div class="col-md-6"><select name="accounttag" class="form-control" id="accountag">
                            <option>Select</option>
                            <option>Yes</option>
