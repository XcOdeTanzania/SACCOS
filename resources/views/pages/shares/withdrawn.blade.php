                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            @for($i=0; $i<3 ; $i++) <tr>
                                ...
                                <td>
                                    <a type="button" data-toggle="modal" data-target="#editShare">
                                        <i class="fa fa-pen m-2 text-primary" data-toggle="tooltip"
                                            data-placement="top" title="Edit">
                                        </i></a>
                                    <a type="button" data-toggle="modal" data-target="#deleteShare">
...
<!--Edit Modal HTML -->
                ...
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Share Info</h4>
        ...
        <!-- Delete Modal HTML -->
        <div id="deleteShare" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
