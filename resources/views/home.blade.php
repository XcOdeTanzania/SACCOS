...
<div class="content-heading">
    <div>
        SAMIS
        <small data-localize="dashboard.WELCOME"> Saccos Records</small>
    </div>
    <!-- START Language list-->
    <div class="ml-auto">
        <div class="btn-group">
...
<div class="row">
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card bg-info-light pt-2 b0">
            ...
            <div data-sparkline="" data-type="line" data-width="100%" data-height="75px" data-line-color="#23b7e5"
                data-chart-range-min="0" data-fill-color="#23b7e5" data-spot-color="#23b7e5"
                data-min-spot-color="#23b7e5" data-max-spot-color="#23b7e5" data-highlight-spot-color="#23b7e5"
                data-highlight-line-color="#23b7e5" data-values="2,5,3,7,4,5" style="margin-bottom: -2px"
    ...
    <div class="col-xl-3 col-md-6">
        ...
        <div class="card bg-purple-light pt-2 b0">
            ...
            <div data-sparkline="" data-type="line" data-width="100%" data-height="75px" data-line-color="#7266ba"
                ...
                data-highlight-line-color="#7266ba" data-values="1,4,5,4,8,7,10" style="margin-bottom: -2px"
                data-resize="true"></div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-lg-6 col-md-12">
        ...
        <div class="card bg-info-light pt-2 b0">
            ...
            <div data-sparkline="" data-type="line" data-width="100%" data-height="75px" data-line-color="#23b7e5"
                data-chart-range-min="0" data-fill-color="#23b7e5" data-spot-color="#23b7e5"
                data-min-spot-color="#23b7e5" data-max-spot-color="#23b7e5" data-highlight-spot-color="#23b7e5"
                data-highlight-line-color="#23b7e5" data-values="4,5,3,10,7,15" style="margin-bottom: -2px"
                data-resize="true"></div>
        </div>
    </div>
</div>
    ...
    <div class="col-xl-12">
        ...
        <div class="card border-0">
            <div class="card-body">
                ...
                <div class="py-4" data-sparkline="" data-type="line" data-height="80" data-width="100%"
                    data-line-width="2" data-line-color="#7266ba" data-spot-color="#888" data-min-spot-color="#7266ba"
                    data-max-spot-color="#7266ba" data-fill-color="" data-highlight-line-color="#fff"
